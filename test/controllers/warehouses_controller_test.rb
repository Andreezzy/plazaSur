...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { product_id: @warehouse.product_id, sale_price: @warehouse.sale_price, stock: @warehouse.stock } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { product_id: @warehouse.product_id, sale_price: @warehouse.sale_price, stock: @warehouse.stock } }
