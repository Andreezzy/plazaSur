...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { pe: @phone.pe, phone: @phone.phone, provider_id: @phone.provider_id } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { pe: @phone.pe, phone: @phone.phone, provider_id: @phone.provider_id } }
