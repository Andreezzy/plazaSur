...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post promotions_url, params: { promotion: { calendar_id: @promotion.calendar_id, description: @promotion.description, discount: @promotion.discount, name: @promotion.name } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { calendar_id: @promotion.calendar_id, description: @promotion.description, discount: @promotion.discount, name: @promotion.name } }
