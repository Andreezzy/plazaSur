...
class BirthdaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create birthday" do
    assert_difference('Birthday.count') do
      post birthdays_url, params: { birthday: { calentar_id: @birthday.calentar_id, customer_id: @birthday.customer_id } }
    end
  ...
  test "should update birthday" do
    patch birthday_url(@birthday), params: { birthday: { calentar_id: @birthday.calentar_id, customer_id: @birthday.customer_id } }
